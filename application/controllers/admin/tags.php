...
class Tags extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model(array('model_comment', 'model_content', 'model_tags'));
	...
	public function index()
	{
		if ($this->functions->get_loged()):
			...
			$data['query'] = $this->model_tags->get_tags();
			var_dump($data['query']->result());
			$data['nb_content'] = $this->model_tags->get_tags_by_tag(1);
			var_dump($data['nb_content']->num_rows());
